...
- [x] **A screenshot comes back blank, and now says why.** Found on 12
  ...
  app needs to capture its own window and which is withdrawn whenever the
  binary changes, and this one has been rebuilt many times today. Nothing can
...
- [x] **A full release QA pass.** Run on 12 September 2026 against a clean
  release build. What was covered, what it found and what could not be tested
  are in the run summary at the top of this file. The brief it followed: The brief is in `qa-release-brief.md`, kept
